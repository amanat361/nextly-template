            ...
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                ...
                <Disclosure.Button
                  ...
                  className="px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden hover:text-rose-500 focus:text-rose-500 focus:bg-rose-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700">
                  <svg
          ...
          <ul className="items-center justify-end flex-1 pt-6 list-none lg:pt-0 lg:flex">
            {navigation.map((menu, index) => (
              <li className="mr-3 nav__item" key={index}>
                <Link href="/" className="inline-block px-4 py-2 text-lg font-normal text-gray-800 no-underline rounded-md dark:text-gray-200 hover:text-rose-500 focus:text-rose-500 focus:bg-rose-100 focus:outline-none dark:focus:bg-gray-800">
                    {menu}
                </Link>
              </li>
            ))}
